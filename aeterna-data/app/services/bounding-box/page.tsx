...
export const metadata: Metadata = {
    ...
    description: 'Professional bounding box annotation for object detection and tracking. IAA-measured quality with Cohen\'s κ ≥ 0.80. GDPR-compliant, NDA-bound workforce.',
    robots: { index: true, follow: true },
    openGraph: {
        title: 'Bounding Box Annotation Service — Aeterna Data',
        description: 'Object detection annotation with IAA-measured quality. Cohen\'s κ ≥ 0.80 guaranteed.',
        url: 'https://aeternadata.com/services/bounding-box',
    },
};

const tocItems = [
    { id: 'what-is-bbox', label: 'What Is Bounding Box Annotation' },
        ...
        <>
                ...
                <div className="max-w-5xl mx-auto px-6 relative z-10 w-full flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-2 gap-y-8 gap-x-4 sm:flex sm:flex-wrap justify-center items-center sm:gap-4 mt-10 font-mono text-sm text-center">
                        <div className="flex flex-col items-center text-center">
                            <span className="text-[var(--color-text-primary)] font-bold">2D + 3D</span>
                            <span className="text-[var(--color-text-muted)] text-xs uppercase tracking-widest mt-1">Box Types</span>
                        </div>
                        <span className="text-[var(--color-border-subtle)] hidden sm:block">|</span>
                        <div className="flex flex-col items-center text-center">
                            <span className="text-[var(--color-text-primary)] font-bold">COCO Â· YOLO</span>
                            <span className="text-[var(--color-text-muted)] text-xs uppercase tracking-widest mt-1">Output Formats</span>
                        </div>
                        <span className="text-[var(--color-border-subtle)] hidden sm:block">|</span>
                        <div className="flex flex-col items-center text-center">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:grid lg:grid-cols-[256px_1fr] lg:gap-16 pt-12 pb-32 w-full">
                ...
                <div className="min-w-0 space-y-24 max-w-3xl">
                    ...
                    {/* SECTION 1: What Is Bounding Box Annotation? */}
                    <AnimatedSection>
                        <section id="what-is-bbox">
                            ...
                            <div className="text-base leading-relaxed text-[var(--color-text-secondary)] space-y-4">
                                <p>
                                    Bounding box annotation is the process of drawing rectangular boxes around objects of interest in an image and assigning each box a class label. It is the most widely used annotation type for object detection â€” the task of training a model to identify where specific objects appear in an image and what category they belong to.
                                </p>
                                <p>
                                ...
                                {[
                                    {
                                        ...
                                        body: "Pedestrian, vehicle, cyclist, and road sign detection for self-driving perception systems."
                                    },
                                    {
                                        title: "Retail & E-commerce",
                                        body: "Product detection on shelves, planogram compliance, and visual inventory systems."
                                    },
                                    {
                                        title: "Security & Surveillance",
                                        body: "Person and object detection for video analytics and access control systems."
                                    },
                                    {
                                        title: "Medical Imaging",
                                        body: "Anatomical structure and pathology localization in radiology and diagnostic imaging datasets."
                                    },
                                    {
                                        title: "Robotics",
                                        body: "Object localization for robotic pick-and-place, manipulation, and navigation systems."
                                    },
                                    {
                                        title: "Drone & Aerial",
                                        body: "Vehicle, structure, and land use detection in aerial and satellite imagery datasets."
                                    }
                                ].map((card, idx) => (
                    ...
                    <AnimatedSection>
                        <section id="annotation-types">
                            ...
                            <div className="space-y-0">
                                {[
                                    {
                                        title: "2D Axis-Aligned Bounding Box",
                                        body: "The standard rectangle drawn horizontally and vertically around an object. Used in the majority of object detection tasks. Supported by all major training frameworks and annotation tools."
                                    },
                                    {
                                        title: "Rotated Bounding Box (OBB)",
                                        body: "An oriented bounding box that follows the angle of the object rather than the image axis. Used for aerial imagery, document analysis, and any task where objects appear at varied angles and axis-aligned boxes would include excessive background."
                                    },
                                    {
                                        title: "Multi-Class Labeling",
                                        body: "Each bounding box is assigned one class label from a defined taxonomy. Aeterna Data validates the taxonomy during the pilot phase and documents any ambiguous class boundaries before production annotation begins."
                                    },
                                    {
                                        title: "Attribute Tagging",
                                        body: "Additional attributes assigned to each bounding box beyond the class label â€” for example, occlusion level, truncation, or object state. Specified in the annotation guidelines before the pilot begins."
                                    }
                                ].map((item, idx) => (
                        ...
                        <section id="output-formats">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                {[
                                    {
                                        format: "COCO JSON",
                                        description: "The standard format for object detection and segmentation tasks. Includes image metadata, category definitions, and per-annotation bounding box coordinates in [x, y, width, height] format. Compatible with most major training frameworks."
                                    },
                                    {
                                        format: "YOLO TXT",
                                        description: "One text file per image containing normalised class and coordinate values. The standard format for YOLO-family models. Simple structure, fast to parse, and directly compatible with Ultralytics training pipelines."
                                    },
                                    {
                                        format: "Custom Format",
                                        description: "If your pipeline requires a different output format â€” Pascal VOC XML, TFRecord, or a proprietary schema â€” this is specified during scoping and delivered as agreed in the SOW."
                                    }
                                ].map((card, idx) => (
                                    <AnimatedSection key={idx} delay={idx * 0.08} className="h-full">
                                        <div className="bg-[var(--color-bg-surface)] border border-[var(--color-border)] rounded-2xl p-6 h-full transition-all duration-150">
                    ...
                    <AnimatedSection>
                        <section id="quality-standard">
                            ...
                            <div className="text-base leading-relaxed text-[var(--color-text-secondary)] space-y-4">
                                <p>
                                    Every bounding box annotation batch delivered by Aeterna Data is measured for inter-annotator agreement before delivery. IAA is not a target â€” it is a threshold. Batches that do not meet the threshold are reworked before the client receives them.
                                </p>
